...
*/
	return array(
		'1_answer' => '೧ ಉತ್ತರ',
		'1_comment' => '೧ ಪ್ರತಿಕ್ರಿಯೆ',
		'1_day' => '೧ ದಿನ',
		'1_disliked' => '೧ ಇಷ್ಟವಾಗದ್ದು',
		'1_flag' => '೧ ಧ್ವಜ',
		'1_hour' => '೧ ಘಂಟೆ',
		'1_liked' => '೧ ಇಷ್ಟ',
		'1_minute' => '೧ ನಿಮಿಷ',
		...
		'1_week' => '೧ ವಾರ',
		'1_year' => '೧ ವರ್ಷ',
		'add_category_x_favorites' => 'ವರ್ಗವನ್ನು ^ ನನ್ನ ನೆಚ್ಚಿನವುಗಳಿಗೆ ಸೇರಿಸು',
		'add_favorites' => 'ನನ್ನ ನೆಚ್ಚಿನವುಗಳಿಗೆ ಸೇರಿಸು',
		'add_tag_x_favorites' => 'ಟ್ಯಾಗ್‌ ಅನ್ನು ^ ನನ್ನ ನೆಚ್ಚಿನವುಗಳಿಗೆ ಸೇರಿಸು',
		'all_categories' => 'ಎಲ್ಲ ವರ್ಗಗಳು',
		'anonymous' => 'ಅನಾಮಿಕ',
		'answer_edited' => 'ಉತ್ತರ ಸಂಪಾದಿಸಲಾಗಿದೆ',
		'answer_reshown' => 'ಉತ್ತರ ಮತ್ತೆ ತೋರಿಸಲಾಗಿದೆ',
		'answer_selected' => 'ಉತ್ತರ ಆಯ್ಕೆಮಾಡಲಾಗಿದೆ',
		...
		'closed' => 'ಮುಚ್ಚಿದೆ',
		'comment_edited' => 'ಪ್ರತಿಕ್ರಿಯೆ ಸಂಪಾದಿಸಲಾಗಿದೆ',
		'comment_moved' => 'ಪ್ರತಿಕ್ರಿಯೆ ಸರಿಸಲಾಗಿದೆ',
		'comment_reshown' => 'ಪ್ರತಿಕ್ರಿಯೆ ಮತ್ತೆ ತೋರಿಸಿದೆ',
		'commented' => 'ಪ್ರತಿಕ್ರಿಯಿಸಲಾಗಿದೆ',
		'date_day_min_digits' => ೧, // ೧ ಅಥವಾ ೨
		...
		'hot_qs_in_x' => 'ಇದರಲ್ಲಿ ಬಿಸಿ ಪ್ರಶ್ನೆ ^',
		'hot_qs_title' => 'ಬಿಸಿ ಪ್ರಶ್ನೆಗಳು',
		...
		'moved' => 'moved',
		'nav_activity' => 'ಎಲ್ಲ ಚಟುವಟಿಕೆಗಳು',
		'nav_admin' => 'ಮುಖ್ಯಸ್ಥ',
		'nav_ask' => 'ಪ್ರಶ್ನೆ ಒಂದನ್ನು ಕೇಳು',
		...
		'nav_login' => 'ಲಾಗಿನ್',
		'nav_logout' => 'ಲಾಗ್‌ಔಟ್',
		'nav_most_answers' => 'ಬಹಳಷ್ಟು ಉತ್ತರಗಳು',
		'nav_most_recent' => 'ಇತ್ತೀಚಿನ',
		'nav_most_views' => 'ಹೆಚ್ಚು ನೋಟಗಳು',
		'nav_most_votes' => 'ಹೆಚ್ಚು ಮತಗಳು',
		'nav_no_answer' => 'ಉತ್ತರ ಲಭ್ಯವಿಲ್ಲ',
		'nav_no_selected_answer' => 'ಆಯ್ಕೆ ಮಾಡಲಾದ ಉತ್ತರವಿಲ್ಲ',
		'nav_no_upvoted_answer' => 'ಮತ ಚಲಾಯಿಸಿದ ಉತ್ತರವಿಲ್ಲ',
		'nav_qa' => 'ಪ್ರ&ಉ',
		'nav_qs' => 'ಪ್ರಶ್ನೆಗಳು',
		'nav_register' => 'ನೊಂದಾಯಿಸಿ',
		'nav_tags' => 'ಟ್ಯಾಗ್‌ಗಳು',
		'nav_unanswered' => 'ಉತ್ತರವಿಲ್ಲದವು',
		'nav_updates' => 'ನನ್ನ ಪರಿಷ್ಕರಣೆಗಳು',
		'nav_users' => 'ಬಳಕೆದಾರರು',
		'no_active_users' => 'ಸಕ್ರಿಯ ಬಳಕೆದಾರ ಕಂಡುಬಂದಿಲ್ಲ',
		'no_answers_found' => 'ಉತ್ತರಗಳು ಕಂಡುಬಂದಿಲ್ಲ',
		'no_answers_in_x' => 'ಇಲ್ಲಿ ಪ್ರಶ್ನೆಗಳಿಲ್ಲ ^',
		'no_categories_found' => 'ವರ್ಗಗಳು ಕಂಡುಬಂದಿಲ್ಲ',
		'no_category' => 'ವರ್ಗವಿಲ್ಲ',
		'no_comments_found' => 'ಪ್ರತಿಕ್ರಿಯೆಗಳು ಕಂಡುಬಂದಿಲ್ಲ',
		'no_comments_in_x' => 'ಇಲ್ಲಿ ಪ್ರತಿಕ್ರಿಯೆಗಳಿಲ್ಲ ^',
		'no_questions_found' => 'ಪ್ರಶ್ನೆಗಳು ಕಂಡುಬಂದಿಲ್ಲ',
		'no_questions_in_x' => 'ಇಲ್ಲಿ ಪ್ರಶ್ನೆಗಳಿಲ್ಲ ^',
		...
		'page_label' => 'ಪುಟ:',
		'page_next' => 'ಮುಂದೆ',
		'page_not_found' => 'ಪುಟ ಲಭ್ಯವಿಲ್ಲ',
		'page_prev' => 'ಹಿಂದೆ',
		'popular_tags' => 'ಅತಿ ಜನಪ್ರಿಯ ಟ್ಯಾಗ್',
		...
		'retagged' => 'retagged',
		'save_button' => 'ಬದಲಾವಣೆಗಳನ್ನು ಉಳಿಸು',
		...
		'send_button' => 'Send',
		'since_x' => 'since ^',
		'suggest_ask' => '^1ಪ್ರಶ್ನೆ ಕೇಳುವುದರೊಂದಿಗೆ^2 ಕೆಲಸ ಪ್ರಾರಂಭಿಸಲು ಸಹಾಯಮಾಡಿ.',
		...
		'x_months' => '^ ತಿಂಗಳುಗಳು',
		'x_points' => '^ ಅಂಕಗಳು',
		'x_questions' => '^ ಪ್ರಶ್ನೆಗಳು',
		'x_seconds' => '^ ಸೆಕೆಂಡುಗಳು',
		'x_tags' => '^ ಟ್ಯಾಗ್‌ಗಳು',
		'x_users' => '^ ಬಳಕೆದಾರರು',
		'x_views' => '^ ನೋಟಗಳು',
		'x_votes' => '^ ಮತಗಳು',
